...
// Lyncx 31-01-26 --- Extract product message into a standalone function so it can also be reused as the header for interactive messages
const prepareProductMessage = async (message, options) => {
    ...
    // Lyncx 01-02-26 --- Add product message default value
 ...
 */
// Lyncx 21-04-26 --- Enhanced prepareStickerPackMessage
const prepareStickerPackMessage = async (message, options) => {
    const { cover, stickers = [], name = '📦 Sticker Pack', publisher = 'GitHub: LyncxTeams', description = '🏷️ LyncxTeams/baileys' } = message;
    ...
    const logger = options.logger;
    // Lyncx 01-02-26 --- Add caching for sticker pack
...
// Lyncx 30-01-26 --- Add native flow button helper for interactive message
const prepareNativeFlowButtons = (message) => {
    ...
    // Lyncx 31-01-26 --- Add offer and options inside interactive message
    ...
    return {
        buttons: correctedField.map(button => {
            ...
            // Lyncx 12-03-26 --- Add "single_select" shortcut ＼⁠(⁠°⁠o⁠°⁠)⁠／
...
// Lyncx 06-02-26 --- Validate album message media to avoid bug 👀
...
// Lyncx 30-01-26 --- Validate carousel cards header to avoid bug 👀
...
export const generateWAMessageContent = async (message, options) => {
    var _a, _b;
    let m = {};
    // Lyncx 30-01-26 --- Add "raw" boolean to send raw messages directly via generateWAMessage()
    if (hasNonNullishProperty(message, 'raw')) {
        delete message.raw;
        return message;
    }
    // Lyncx 09-04-26 --- Add support for code block and table with richResponseMessage
        ...
        if (message.poll.toAnnouncementGroup) {
            ...
            // Lyncx 08-02-26 --- Add quiz message support
    ...
    // Lyncx 08-02-26 --- Add poll result snapshot message
    ...
    // Lyncx 08-02-26 --- Add poll update message
    ...
    // Lyncx 01-02-26 --- Add payment invite message
    ...
    // Lyncx 01-02-26 --- Add order message
    ...
    // Lyncx 31-01-26 --- Add support for album messages
    ...
    // Lyncx 30-01-26 --- Add interactive messages (buttonsMessage, listMessage, interactiveMessage, templateMessage, and carouselMessage)
    if (hasNonNullishProperty(message, 'buttons')) {
        const buttonsMessage = {
            buttons: message.buttons.map(button => {
                // Lyncx 12-03-26 --- Add "single_select" shortcut!
                const buttonText = button.text || button.buttonText;
    ...
    // Lyncx 01-02-26 --- Add request payment message
    ...
    // Lyncx 01-02-26 --- Add invoice message
    ...
    // Lyncx 31-01-26 --- Add direct externalAdReply access (no need to create contextInfo first)
    ...
    // Lyncx 31-01-26 --- Add "groupStatus" boolean to set contextInfo.isGroupStatus and wrap message into groupStatusMessageV2
    ...
    // Lyncx 06-05-26 --- Add "spoiler" boolean to set contextInfo.isSpoiler and wrap message into spoilerMessage
    ...
    // Lyncx 02-02-26 --- Add "interactiveAsTemplate" boolean to wrap interactiveMessage into templateMessage
    ...
    // Lyncx 30-01-26 --- Add "ephemeral" boolean to wrap message into ephemeralMessage like "viewOnce"
    if (hasOptionalProperty(message, 'ephemeral') && !!message.ephemeral) {
        m = { ephemeralMessage: { message: m } };
        delete message.ephemeral;
    }
    // Lyncx 16-05-26 --- Add wrap message into lottieStickerMessage by isLottie boolean
    ...
    // Lyncx 03-02-26 --- Add "viewOnceV2" boolean to wrap message into viewOnceMessageV2 like "viewOnce"
    else if (hasOptionalProperty(message, 'viewOnceV2') && !!message.viewOnceV2) {
        m = { viewOnceMessageV2: { message: m } };
        delete message.viewOnceV2;
    }
    // Lyncx 03-02-26 --- Add "viewOnceV2Extension" boolean to wrap message into viewOnceMessageV2Extension like "viewOnce"
...
export const generateWAMessageFromContent = (jid, message, options) => {
    ...
    // Lyncx 30-01-26 --- Add deviceListMetadata inside messageContextInfo for private chat
...
export const normalizeMessageContent = (content) => {
    ...
    return content;
    // Lyncx 03-02-26 --- Add all futureProofMessage into getFutureProofMessage()
